...
class PatientRecord extends Component<Props, State> {
  state = initialState;
  ...
  load = (): void => {
    ...
    MedicalHistoryService.get({
      ...
      .catch((err: AxiosError) => {
        console.log('PatientRecord: load: ', err);
            ...
            navigation.navigate('RecordForm', {
              onSuccess: (
                ...
                MedicalHistoryService.create(
                  ...
                  .catch(err => {
                    console.log("PatientRecord: addButton's onSuccess: ", err);
                    this.setState({isLoading: false});
                  });
              },
            });
    ...
    return (
      <Item
        ...
        onPress={(): void => {
          ...
          navigation.navigate('PatientRecordForm', {
            initialForm: {
              title: item.title,
            ...
            onSuccess: (
              ...
              MedicalHistoryService.edit(
                ...
                .catch(err => {
                  console.log("PatientRecord: Item's onSuccess: ", err);
                  this.setState({isLoading: false});
                });
            },
          });
